...
# El proceso de lectura es mas rapido
...
```{r}
# Por defecto se utiliza el método pearson si no se especifica parámetros
cor(casas)
```
...
# Para el caso utilizaremos pearson dado que queremos realizar una evaluación lineal entre price & sqft_living
# link de referencia => https://support.minitab.com/en-us/minitab-express/1/help-and-how-to/modeling-statistics/regression/supporting-topics/basics/a-comparison-of-the-pearson-and-spearman-correlation-methods/
cor(casas, method='pearson')
